...
public class AddTrailersViewModelFactory extends ViewModelProvider.NewInstanceFactory {
    ...
    public AddTrailersViewModelFactory(FilmDatabase database, String filmId) {
        mDb = database;
        mFilmId = filmId;
    }
    ...
    public <T extends ViewModel> T create(Class<T> modelClass) {
        ...
        return (T) new AddTrailersViewModel(mDb, mFilmId);
    }
}
